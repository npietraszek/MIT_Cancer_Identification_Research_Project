...
weight_save_folder=r"D:\MIT_Tumor_Identifcation_Project_Stuff\Phase_2_stuff\Machine Learning\Weights\4_16_21_new_run_3_(new_20X_model_12,step_decay_modify_2)\Superloop_run_2"
...
file1 = open(os.path.join(r"D:\MIT_Tumor_Identifcation_Project_Stuff\Phase_2_stuff\Machine Learning\Weights\4_16_21_new_run_3_(new_20X_model_12,step_decay_modify_2)\Superloop_run_2","Datasets.txt"),"r")
...
for file_index in range(len(final_testing_data)):
    final_compiled_testing_data.append(final_testing_data[file_index])
    final_compiled_testing_labels.append(final_testing_labels[file_index])
...
model.load_weights(os.path.join(r"D:\MIT_Tumor_Identifcation_Project_Stuff\Phase_2_stuff\Machine Learning\Weights\4_16_21_new_run_3_(new_20X_model_12,step_decay_modify_2)\Superloop_run_2",r"4_16_21_Test3_DNN.40.hdf5"))
correct_counter = 0
