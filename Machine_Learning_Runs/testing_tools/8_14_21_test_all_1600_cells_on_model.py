...
file1 = open(os.path.join(r"D:\MIT_Tumor_Identifcation_Project_Stuff\June_Finishing_Project\Runs\only_DAPI\10_2_21_test1_(only_DAPI)\Superloop_run_0","Datasets.txt"),"r")
...
model.load_weights(os.path.join(r"D:\MIT_Tumor_Identifcation_Project_Stuff\June_Finishing_Project\Runs\only_DAPI\10_2_21_test1_(only_DAPI)\Superloop_run_0",r"10_2_21_test1_DNN.14.hdf5"))
correct_counter = 0
