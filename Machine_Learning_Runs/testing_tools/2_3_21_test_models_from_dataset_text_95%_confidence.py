...
file1 = open(os.path.join(r"D:\MIT_Tumor_Identifcation_Project_Stuff\Phase_2_stuff\Machine Learning\Weights\2_7_21_new_run_1_(new_model_4,nostandard_harsh_bal,tile_track_1600_seperate)\Superloop_run_0","Datasets_superloop_0.txt"),"r")
...
file1 = open(os.path.join(directory_to_write_to,r"2_9_21_VERIFYtest_results_rotated_1600_set.txt"),"a")#append mode
file1.write("2_9_21_test_results_1 \n")
