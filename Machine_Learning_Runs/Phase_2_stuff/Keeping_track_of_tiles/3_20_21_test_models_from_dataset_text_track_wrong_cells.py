...
epoch_part_model = r"1_16_21_Test1_balanced_0.001learning_DNN.29.hdf5"
...
incorrect_fibroblast_cells_list = []
incorrect_cancer_cells_list = []
correct_cancer_cells_list = []
correct_fibroblast_cells_list = []
for i in range(400):
    is_correct = False
    ...
    if current_prediction_index == testing_answer_index:
        ...
        if testing_answer[0] == 1:
            # Fibroblast
            correct_fibroblast_cells_list.append(final_testing_data[i])
        else:
            # cancer cell
            correct_cancer_cells_list.append(final_testing_data[i])
    else:
        if testing_answer[0] == 1:
            # Fibroblast
            incorrect_fibroblast_cells_list.append(final_testing_data[i])
        else:
            # cancer cell
            incorrect_cancer_cells_list.append(final_testing_data[i])
...
print("The maximum accuracy was " + str(correct_counter)
      + " with testing loss " + str(test_acc)
      + " out of " + str(len(final_testing_data)))
print("Total number of epochs = " + str(nb_epochs))
for x in correct_cancer_cells_list:
    print("CORRECT CANCER CELL")
    print(x)
print(len(correct_cancer_cells_list))
for x in correct_fibroblast_cells_list:
    print("CORRECT FIBROBLAST CELL")
    print(x)
print(len(correct_fibroblast_cells_list))
for x in incorrect_cancer_cells_list:
    print("INCORRECT CANCER CELL")
    print(x)
print(len(incorrect_cancer_cells_list))
for x in incorrect_fibroblast_cells_list:
    print("INCORRECT FIBROBLAST CELL")
    print(x)
print(len(incorrect_fibroblast_cells_list))
list_of_accuracy_values.append(correct_counter)
list_of_testing_loss.append(test_acc)
'''
