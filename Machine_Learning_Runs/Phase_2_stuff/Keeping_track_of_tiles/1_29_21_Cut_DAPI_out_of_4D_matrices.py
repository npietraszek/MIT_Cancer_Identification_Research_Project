...
Program to take 4D matrices already generated and cut the DAPI image type out of them, then save them to
...
def remove_DAPI_from_4D(array_to_remove_from):
...
new_directory = r"D:\MIT_Tumor_Identifcation_Project_Stuff\phase2_1_28_21\step9 no_DAPI_without_1600"
...
for the_directory in list_of_directories_to_walk:
    for root, dirs, files in os.walk(os.path.join(starting_directory,the_directory)):
        ...
        for dir in dirs:
            ...
            new_array_1 = remove_DAPI_from_4D(final_array_1)
            new_array_2 = remove_DAPI_from_4D(final_array_2)
            new_array_3 = remove_DAPI_from_4D(final_array_3)
            new_array_4 = remove_DAPI_from_4D(final_array_4)
...
new_directory = r"D:\MIT_Tumor_Identifcation_Project_Stuff\Usable_5D_matrices\7_7_20_No_DAPI_rotated_4D_(harsh_no_strange_cells)"
checkDirectory(starting_directory)
checkDirectory(new_directory)
