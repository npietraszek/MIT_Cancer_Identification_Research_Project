...
def remove_brightfield_and_DAPI_from_4D(array_to_remove_from):
...
new_directory = r"D:\MIT_Tumor_Identifcation_Project_Stuff\May_Cutting_Image_Types\Only_Reflective_1600_cells"
...
# This should cut [0] and [2], leaving [1]
...
for the_directory in list_of_directories_to_walk:
    for root, dirs, files in os.walk(os.path.join(starting_directory,the_directory)):
        ...
        for dir in dirs:
            ...
            new_array_1 = remove_brightfield_and_DAPI_from_4D(final_array_1)
            new_array_2 = remove_brightfield_and_DAPI_from_4D(final_array_2)
            new_array_3 = remove_brightfield_and_DAPI_from_4D(final_array_3)
            new_array_4 = remove_brightfield_and_DAPI_from_4D(final_array_4)
