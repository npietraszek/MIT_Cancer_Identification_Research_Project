...
10/1/21
Modified version sucessfully bugtested.
'''
...
new_directory = r"D:\MIT_Tumor_Identifcation_Project_Stuff\May_Cutting_Image_Types\Only_DAPI_1600_cells"
...
for the_directory in list_of_directories_to_walk:
    for root, dirs, files in os.walk(os.path.join(starting_directory,the_directory)):
        ...
        for dir in dirs:
            ...
            new_array_1 = remove_brightfield_and_reflective_from_4D(final_array_1)
            new_array_2 = remove_brightfield_and_reflective_from_4D(final_array_2)
            new_array_3 = remove_brightfield_and_reflective_from_4D(final_array_3)
            new_array_4 = remove_brightfield_and_reflective_from_4D(final_array_4)
