...
10/1/21
Modified version successfully bugtested
'''
...
def remove_reflective_and_DAPI_from_4D(array_to_remove_from):
    #assert array_to_remove_from
...
new_directory = r"D:\MIT_Tumor_Identifcation_Project_Stuff\May_Cutting_Image_Types\Only_Brightfield_without_1600"
...
# This should cut [0] and [1], leaving [2]
...
for the_directory in list_of_directories_to_walk:
    for root, dirs, files in os.walk(os.path.join(starting_directory,the_directory)):
        ...
        for dir in dirs:
            ...
            new_array_1 = remove_reflective_and_DAPI_from_4D(final_array_1)
            new_array_2 = remove_reflective_and_DAPI_from_4D(final_array_2)
            new_array_3 = remove_reflective_and_DAPI_from_4D(final_array_3)
            new_array_4 = remove_reflective_and_DAPI_from_4D(final_array_4)
