...
for superloop_counter in range(superloop_rounds):
    ...
    weight_save_folder=r"D:\MIT_Tumor_Identifcation_Project_Stuff\Phase_2_stuff\Machine Learning\Weights\2_3_21_new_run_1_(new_model_4,nostandard_harsh_bal,cut_DAPI_1600_seperate)\Superloop_run_{0}".format(superloop_counter)
    shortened_weight_save_folder = os.path.split(weight_save_folder)[0]
    starting_directory = r"D:\MIT_Tumor_Identifcation_Project_Stuff\phase2_1_28_21\step9 no_DAPI_without_1600"
    saved_1600_cells_directory = r"D:\MIT_Tumor_Identifcation_Project_Stuff\phase2_1_28_21\step9_no_DAPI_1600_cells"
    filepath=os.path.join(weight_save_folder,"2_3_21_Test1_balanced_0.001learning_DNN.{epoch:02d}.hdf5")
    filename=os.path.join(weight_save_folder,'training.log')
    checkDirectory(weight_save_folder)

    epoch_name_part_1 = r"2_3_21_Test1_balanced_0.001learning_DNN."
...
file1 = open(os.path.join(directory_to_write_to,r"2_3_21_test_results_rotated_2000_set_cutting_DAPI.txt"),"a")#append mode
file1.write("2_3_21_test_results_rotated_2000_set_cutting_DAPI_results \n")
