...
for superloop_counter in range(superloop_rounds):
    ...
    weight_save_folder=r"D:\MIT_Tumor_Identifcation_Project_Stuff\Phase_2_stuff\Machine Learning\Weights\1_10_21_new_run_1_(new_model_4,no_standard-harsh_bal(20-50-50),keep_1600_seperate)\Superloop_run_{0}".format(superloop_counter)
    shortened_weight_save_folder = r"D:\MIT_Tumor_Identifcation_Project_Stuff\Phase_2_stuff\Machine Learning\Weights\1_10_21_new_run_1_(new_model_4,no_standard-harsh_bal(20-50-50),keep_1600_seperate)"
    ...
    filepath=os.path.join(weight_save_folder,"1_10_21_Test1_balanced_0.001learning_DNN.{epoch:02d}.hdf5")
    filename=os.path.join(weight_save_folder,'training.log')
    checkDirectory(weight_save_folder)

    epoch_name_part_1 = r"1_10_21_Test1_balanced_0.001learning_DNN."
...
file1 = open(os.path.join(weight_save_folder, r"Datasets.txt"), "r")
...
for x in range(100):
    shuffle(final_training_data)
    shuffle(final_training_labels)
    shuffle(final_validation_data)
    shuffle(final_validation_labels)
    shuffle(final_testing_data)
    shuffle(final_testing_labels)
    shuffle(compiled_testing_data)
    shuffle(compiled_testing_labels)
...
file1 = open(os.path.join(directory_to_write_to,r"1_10_21_test_results_rotated_2000_set.txt"),"a")#append mode
file1.write("1_10_21_test_results_1 \n")
