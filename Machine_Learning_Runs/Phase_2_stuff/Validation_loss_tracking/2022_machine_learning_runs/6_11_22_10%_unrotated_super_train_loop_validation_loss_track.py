...
def get_the_unrotated_files():
    ...
    # Standardizing the testing cells to be 400.
    # Validation remains the same at 10, 10% of what it used to be at 100
...
for superloop_counter in range(superloop_rounds):
    ...
    weight_save_folder=r"D:\MIT_Tumor_Identifcation_Project_Stuff\June_Finishing_Project\Runs\Cut_rotation_all_runs\10%_Training_Images\6_11_22_cut_rotate_run_1\Superloop_run_{0}".format(superloop_counter)
...
file1.write("6_11_22_test_results_1  \n")
