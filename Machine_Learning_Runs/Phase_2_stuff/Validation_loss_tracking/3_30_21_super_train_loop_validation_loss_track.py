...
for superloop_counter in range(superloop_rounds):
    ...
    weight_save_folder=r"D:\MIT_Tumor_Identifcation_Project_Stuff\Phase_2_stuff\Machine Learning\Weights\4_10_21_new_run_1_(new_20X_model_12,step_decay_modify_2)\Superloop_run_{0}".format(superloop_counter)
    ...
    filepath=os.path.join(weight_save_folder,"4_10_21_Test1_DNN.{epoch:02d}.hdf5")
    filename=os.path.join(weight_save_folder,'training.log')
    text_results_file_name = "4_10_21_test1_results_rotated_1600_set.txt"
    model_name_to_use = "new_20X_model_12"
    step_decay_thing = "step_decay_modify_2"
    checkDirectory(weight_save_folder)

    epoch_name_part_1 = r"4_10_21_Test1_DNN."
...
file1.write("4_10_21_test_results_1 \n")
