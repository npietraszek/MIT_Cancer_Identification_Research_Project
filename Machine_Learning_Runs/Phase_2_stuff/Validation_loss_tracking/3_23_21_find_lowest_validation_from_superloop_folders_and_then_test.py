...
min_valid_loss_dict = {}
epoch_count = 40
validation_data_file_path = r"D:\MIT_Tumor_Identifcation_Project_Stuff\Phase_2_stuff\Machine Learning\Weights\3_21_21_new_run_2_(new_model_4,no_standard-harsh_bal(20-50-50),tile_keep_1600_seperate)"
...
for superloop_directory in list_of_directories_to_walk:
    ...
    for epoch_number in range(epoch_count):
        ...
        if newest_value < current_minimum_loss:
            ...
            epoch_with_lowest_loss = epoch_number
...
for x in range(100):
    ...
    final_saved_testing_zip = list(zip(final_saved_testing_data, final_saved_testing_labels))
    random.shuffle(final_saved_testing_zip)
    final_saved_testing_data, final_saved_testing_labels = zip(*final_saved_testing_zip)
    ...
    test_gen = nicholas_generator(final_saved_testing_data[0:400],final_saved_testing_labels[0:400],batch_sz)
...
file1 = open(os.path.join(directory_to_write_to,r"3_21_21_VERIFYtest_results_rotated_1600_set.txt"),"a")#append mode
file1.write("3_21_21_test_results_1 \n")
