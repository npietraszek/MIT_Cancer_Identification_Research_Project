...
import nicholas_models_phase_2 as md
...
for superloop_counter in range(superloop_rounds):
    ...
    weight_save_folder=r"D:\MIT_Tumor_Identifcation_Project_Stuff\Phase_2_stuff\Machine Learning\Weights\12_24_20_new_run_1_(model_4,50-90-standard-harsh_bal(20-50-50),0.001_learning,rotate)\Superloop_run_{0}".format(superloop_counter)
    starting_directory = r"D:\MIT_Tumor_Identifcation_Project_Stuff\Phase_2_stuff\New_20X_images\Macro V5 images\20X (50-90 confidence standard) Macro V5\step7 Rotated 4D matrices (20-50-50)"
    filepath=os.path.join(weight_save_folder,"12_24_20_Test1_balanced_0.001learning_DNN.{epoch:02d}.hdf5")
    filename=os.path.join(weight_save_folder,'training.log')
    checkDirectory(weight_save_folder)

    epoch_name_part_1 = r"12_24_20_Test1_balanced_0.001learning_DNN."
    epoch_name_part_2 = r".hdf5"

    # Define what the model is here
    shape_aux= (3,20,50,50)
    model = md.new_20X_model_5(input_shape=shape_aux)
    model.summary()
