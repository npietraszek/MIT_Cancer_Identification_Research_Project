...
for superloop_counter in range(superloop_rounds):
    ...
    weight_save_folder=r"D:\MIT_Tumor_Identifcation_Project_Stuff\Phase_2_stuff\Machine Learning\Weights\2_9_21_new_run_1_(new_model_4,nostandard_harsh_bal,tile_track_1600_seperate)\Superloop_run_{0}".format(superloop_counter)
    shortened_weight_save_folder = os.path.split(weight_save_folder)[0]
    starting_directory = r"D:\MIT_Tumor_Identifcation_Project_Stuff\phase2_1_28_21\step9 no_reflective_without_1600"
    saved_1600_cells_directory = r"D:\MIT_Tumor_Identifcation_Project_Stuff\phase2_1_28_21\step9_no_reflective_1600_cells"
    filepath=os.path.join(weight_save_folder,"2_9_21_Test1_balanced_0.001learning_DNN.{epoch:02d}.hdf5")
    filename=os.path.join(weight_save_folder,'training.log')
    checkDirectory(weight_save_folder)

    epoch_name_part_1 = r"2_9_21_Test1_balanced_0.001learning_DNN."
    epoch_name_part_2 = r".hdf5"

    # Define what the model is here
    shape_aux= (2,20,50,50)
    ...
    file1 = open(os.path.join(weight_save_folder, r"Datasets_superloop_{0}".format(superloop_counter) + ".txt"), "a")  # append mode
    ...
    file1 = open(os.path.join(weight_save_folder, r"Strongest_neuralnetwork" + ".txt"), "a")  # append mode
    file1.write("Results for this run \n")
    file1.write(str("The superloop maximum accuracy was " + str(superloop_maximum_accuracy)
                    + " with testing loss " + str(superloop_testing_loss_with_maximum_accuracy)
                    + " at epoch " + str(superloop_epoch_with_maximum_accuracy)
                    + " at superloop loop counter " + str(superloop_counter_maximum_accuracy)) + "\n")  # 1
    file1.write("       ----END----")
...
file1 = open(os.path.join(shortened_weight_save_folder, r"Superloop_run_{0}".format(str(superloop_counter_maximum_accuracy)), r"Datasets_superloop_{0}".format(str(superloop_counter_maximum_accuracy)) + ".txt"), "r")
...
file1 = open(os.path.join(directory_to_write_to,r"2_7_21_test_results_rotated_2000_set_tile_track.txt"),"a")#append mode
file1.write("2_7_21_test_results_rotated_2000_set_tile_track_results \n")
